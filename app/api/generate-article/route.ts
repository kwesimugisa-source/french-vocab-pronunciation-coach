...
import { THEATRE_GENERATION_SCHEMA, validateTheatreCharacters } from "../../../lib/theatre-characters";
...
async function handlePost(req: Request) {
  try {
    ...
    if (body.contentType === "theatre") {
      doc.theatreCharacters = validateTheatreCharacters((parsed as { characters?: unknown }).characters, doc.text);
      delete (doc as unknown as Record<string, unknown>).characters;
    }
